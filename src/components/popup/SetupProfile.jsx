...
const SetupProfile = ({ isNewUser }) => {
    ...
    // Close the popup if not a new user or if isOpen is false
        ...
        <div className='fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center'>
            <div className='w-[850px]'>
                <div className='flex justify-end'>
                    <button className='text-red-600 text-xl place-self-end font-bold mr-3' onClick={onClose}>X</button>
                </div>
                <div className='rounded bg-bar p-2 grid grid-cols-12'>
                    <div className='col-span-6 p-5 pt-32 justify-center text-center ml-2'>
                        ...
                        <p className='pt-5 pb-5 text-light font-lg'>Enter the world of endless opportunities and discover jobs of all kinds.</p>
